...
f_replaceVar <- function(variable_orig){
  return(
    case_when(
      ...
      variable_orig== "rm" ~ "Comuna pertence a la RM",
      ...
      variable_orig== "perc_letalidad" ~ "% CFR COVID",
      variable_orig== "cfr_0_20" ~ "% CFR-DL Lag 0-20",
      variable_orig== "cfr_10_20" ~ "% CFR-DL Lag 10-20",
      variable_orig== "cfr_0_30" ~ "% CFR-DL Lag 0-30",
      variable_orig== "cfr_raw_0" ~ "% CFR-DL Lag 0",
      variable_orig== "cfr_raw_10" ~ "% CFR-DL Lag 10",
      variable_orig== "cfr_raw_20" ~ "% CFR-DL Lag 20",
      variable_orig== "ifr_0_20" ~ "% IFR-DL Lag 0-20",
      variable_orig== "ifr_10_20" ~ "% IFR-DL Lag 10-20",
      variable_orig== "ifr_0_30" ~ "% IFR-DL Lag 0-30",
      variable_orig== "ifr_raw_0" ~ "% IFR-DL Lag 0",
      variable_orig== "ifr_raw_10" ~ "% IFR-DL Lag 10",
      variable_orig== "ifr_raw_20" ~ "% IFR-DL Lag 20",
      variable_orig== "tasa_mortalidad_all" ~ "Tasa Mortalidad Total [por 100mil]",
      variable_orig== "def_total" ~ "Número fallecidos todas las causas",
      variable_orig== "def_allCauses" ~ "Número fallecidos sin causas externas",
      ...
      variable_orig== "mp10" ~ "MP10 2017-2019 [ug/m3]",
      variable_orig== "mp10_fall" ~ "MP10 2017-2019 Otoño",
      variable_orig== "mp10_winter" ~ "MP10 2017-2019 Invierno",
      variable_orig== "mp10_spring" ~ "MP10 2017-2019 Primavera",
      variable_orig== "mp10_summer" ~ "MP10 2017-2019 Verano",
      variable_orig== "mp10_2017" ~ "MP10 2017 [ug/m3]",
      ...
      variable_orig== "0-14" ~ "% Edad 0-14",
      variable_orig== "e0_14" ~ "% Edad 0-14",
      variable_orig== "`15-44`" ~ "% Edad 15-44",
      variable_orig== "15-44" ~ "% Edad 15-44",
      variable_orig== "e15_44" ~ "% Edad 15-44",
      variable_orig== "`45-64`" ~ "% Edad 45-64",
      variable_orig== "45-64" ~ "% Edad 45-64",
      variable_orig== "e45_64" ~ "% Edad 45-64",
      variable_orig== "`65-74`" ~ "% Edad 65-74",
      variable_orig== "65-74" ~ "% Edad 65-74",
      variable_orig== "e65_74" ~ "% Edad 65-74",
      variable_orig== "`65+`"~ "% Edad 65+",
      variable_orig== "65+"~ "% Edad 65+",
      variable_orig== "e65_plus" ~ "% Edad 65+",
      variable_orig== "`75+`"~ "% Edad 75+",
      variable_orig== "75+"~ "% Edad 75+",
      variable_orig== "e75_plus" ~ "% Edad 75+",
      ...
      variable_orig== "perc_vivSinHac" ~ "% Viviendas sin Hacinamiento \n(menos de 2.5 hab por dormitorio)",
      variable_orig== "perc_vivHacMedio" ~ "% Viviendas Hacinamiento medio \n(entre 2.5 y 5 hab por dormitorio)",
      variable_orig== "perc_vivHacCritico" ~ "% Viviendas Hacinamiento crítico \n(más de 5 hab por dormitorio)",
  ...
  return(
    case_when(
      ...
      var %in% c("poblacion","densidad_pob","densidad_pob_censal",
                 ...
                 "perc_vivAntes2002") ~ 
        "Demografía",
      str_detect(var, "def_") ~ "Demografía", 
