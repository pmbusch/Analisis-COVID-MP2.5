...
f_replaceVar <- function(variable_orig){
  return(
    case_when(
     ...
     variable_orig== "mp25_fall" ~ "MP2.5 Otoño",
     variable_orig== "mp25_winter" ~ "MP2.5 Invierno",
     variable_orig== "mp25_spring" ~ "MP2.5 Primavera",
     variable_orig== "mp25_summer" ~ "MP2.5 Verano",
