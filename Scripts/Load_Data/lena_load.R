...
df_lena <- read_excel("Data/Data_Original/ConsumoLena_CDT.xlsx", sheet="Consumo")
...
df_energia_lena <- read_excel("Data/Data_Original/bbdd_estudio_caracterizacion_residencial_2018_0.xlsx",
