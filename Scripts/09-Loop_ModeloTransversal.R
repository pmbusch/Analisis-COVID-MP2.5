...
name_depend <- c("MR","MR65","MR75","CFR","CFR_DL0","CFR_DL0a20")
...
# Solo con endpoint de tasa de mortalidad (def/pob)
primeraMuerte_explicativa <- c("scale(dias_primerMuerte)")
